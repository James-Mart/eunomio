...
const tabsListVariants = cva("inline-flex items-center text-muted-foreground", {
  variants: {
    variant: {
      ...
      underline: "h-10 w-full justify-start gap-4 border-b border-border bg-transparent p-0",
    },
  },
  defaultVariants: {
    variant: "default",
  ...
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        underline:
          "relative -mb-px rounded-none border-b-2 border-transparent px-1 pb-2 pt-1 data-[state=active]:border-attention data-[state=active]:text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
